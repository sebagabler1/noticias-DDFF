@echo off
:: Instala la tarea programada "PublicarResumenDF" que corre todos los dias a las 12:30
:: (15 minutos despues de Cowork generar el Resumen).
...
echo Todos los dias a las 12:30 se publicara el resumen del dia.
