...
El sitio se actualiza solo cada día a las 11:40 (10 min después de Cowork),
...
11:40 → tarea programada "PublicarResumenDF" → ejecuta publicar.py:
...
11:41 → GitHub Pages publica automáticamente la nueva versión
```
